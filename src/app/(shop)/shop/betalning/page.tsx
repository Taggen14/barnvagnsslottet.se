...
export const metadata: Metadata = {
  title: "Betalningsinformation | TPF Service",
  description:
    "Information om betalningsalternativ och villkor för TPF Service.",
};
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <section className="mt-8 space-y-6">
            ...
            <p>
              TPF Service erbjuder följande betalningsalternativ för att göra
              din köpupplevelse så smidig som möjligt:
            </p>
          ...
          <section className="mt-8 space-y-6">
            ...
            <p>
              När du handlar på TPF Service gäller följande betalningsvillkor:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Varorna förblir TPF Services egendom tills full betalning har
                mottagits.
              </li>
            </ul>
          </section>
          ...
          <section className="mt-8 space-y-6">
            ...
            <div className="mt-2">
              <p>E-post: info@tpfservice.se</p>
              <p>Telefon: 0345 55 94 107</p>
            </div>
          </section>
        </div>
      </div>

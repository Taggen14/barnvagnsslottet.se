...
export const metadata: Metadata = {
  title: "Leveransinformation | TPF Service",
  description:
    "Information om leveranstider, fraktkostnader och leveransmetoder för TPF Service.",
};
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <section className="mt-8 space-y-6">
            ...
            <p>TPF Service erbjuder följande leveransalternativ:</p>

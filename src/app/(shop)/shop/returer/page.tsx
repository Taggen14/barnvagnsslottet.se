...
export const metadata: Metadata = {
  title: "Returer & Reklamationer | TPF Service",
  description:
    "Information om returer, reklamationer och garantier hos TPF Service.",
};
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <section className="mt-8 space-y-6">
            ...
            <p>
              TPF Service lämnar minst 12 månaders garanti på alla produkter om
              inget annat anges. Garantin täcker material- och tillverkningsfel.
            </p>
